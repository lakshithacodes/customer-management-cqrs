...
using CustomerManagement.Handlers.CommandHandlers;
using CustomerManagement.Handlers.QueryHandler;
...
namespace CustomerManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("CustomerDataConnection"));
            });

            services.AddScoped<ISaveCustomerCommandHandler, SaveCustomerCommandHandler>();
            services.AddScoped<IAllCustomerQueryHandler, AllCustomerQueryHandler>();


            services.AddScoped<ICustomerIdQueryHandler, CustomerIdQueryHandler>();
